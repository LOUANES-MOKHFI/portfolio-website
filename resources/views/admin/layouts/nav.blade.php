        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="{{url('/admin/projects')}}" class="nav-link active">
                  <i class="fa fa-connectdevelop"></i>
                  <p>   Liste des projets</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="{{url('/admin/services')}}" class="nav-link active bg-green">
                  <i class="fa fa-rocket"></i>
                  <p>  Liste des services</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="{{url('/admin/technologies')}}" class="nav-link bg-red">
                  <i class="fa fa-connectdevelop"></i>
                  <p>   Liste des technologies</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('/admin/newsletter')}}" class="nav-link bg-red">
                  <i class="fa fa-connectdevelop"></i>
